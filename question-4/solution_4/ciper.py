...
class Ciper(object):
    ...
    #coins_to_pay
    # def ciper_job(self,index,manual_activation_price,place_mine_price):
    #     if map_status(self.mine_map):
    #         #recurtion break
    #         return 0
    #     if index < self.mine_map.__len__():
    #         #check if ther is a mine:
    #         if self.mine_map[index] == '1':
    #             mine_before_activation = self.mine_map.copy()
    #             manual_activation(self.mine_map,index)
    #             return min(self.ciper_job(self.mine_map.copy(),index + 1,manual_activation_price,place_mine_price) + manual_activation_price,
    #                         self.ciper_job(mine_before_activation,index + 1,manual_activation_price,place_mine_price))
    #         else:#If there is no mine
    #             #place a mine under a building , or do nathing.
    #             mine_before_pacing = self.mine_map.copy()
    #             place_mine_list(self.mine_map,index)
    #             return min(self.ciper_job(self.mine_map.copy(),index + 1,manual_activation_price,place_mine_price) + place_mine_price,
    #                         self.ciper_job(mine_before_pacing,index + 1,manual_activation_price,place_mine_price))
    #     else:
    #         #recurtion break
    #         return self.mine_map.__len__() * manual_activation_price + self.mine_map.__len__() * place_mine_price # return max value to make shure the sequence of operation will not count as  the minimum number of coins that the sapper will have to pay.
    #
    #
    # def solve(self,manual_activation_price,place_mine_price):
    #     self.ciper_job(0,manual_activation_price,place_mine_price)
    #
